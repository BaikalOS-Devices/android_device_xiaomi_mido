...
public class RestoreService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (shouldRestorePreset) {
            ...
            KcalExtrasDialogFragment.restore(StaticMembers.FILE_LEVEL_KCAL_MIN, this, StaticMembers.DEFAULT_VALUE_KCAL_MIN);
            KcalExtrasDialogFragment.restore(StaticMembers.FILE_LEVEL_KCAL_SAT, this, StaticMembers.DEFAULT_VALUE_KCAL_SAT);
            KcalExtrasDialogFragment.restore(StaticMembers.FILE_LEVEL_KCAL_HUE, this, StaticMembers.DEFAULT_VALUE_KCAL_HUE);
            KcalExtrasDialogFragment.restore(StaticMembers.FILE_LEVEL_KCAL_VAL, this, StaticMembers.DEFAULT_VALUE_KCAL_VAL);
            KcalExtrasDialogFragment.restore(StaticMembers.FILE_LEVEL_KCAL_CONT, this, StaticMembers.DEFAULT_VALUE_KCAL_CONT);
